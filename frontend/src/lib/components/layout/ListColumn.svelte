...
<details bind:this={listEl} class="main-detail" open={true}>
    <summary class="list-summary">
        ...
        <details class="extra-detail" open={false}>
            <summary onclick={(e:MouseEvent)=>{e.stopPropagation();}} class="menu-summary" >
                <svg
            ...
            <div class="panel" >
                <button onclick={handleEdit} aria-label="edit"><svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
						stroke-width="1.5"
                ...
                <button onclick={handleDelete} aria-label="delete"><svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
						stroke-width="1.5"
